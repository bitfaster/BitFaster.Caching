...
namespace BitFaster.Caching.UnitTests.Lfu
{
    ...
    public class CMSketchBlockSegmentAvx2Tests : CmSketchBlockSegmentTestBase<DetectIsa>
    {
    }

    // Test with AVX2 disabled
    public class CmSketchBlockSegmentTests : CmSketchBlockSegmentTestBase<DisableHardwareIntrinsics>
    {
    }

    public abstract class CmSketchBlockSegmentTestBase<I> where I : struct, IsaProbe
    {
        private CmSketchBlockSegment<int, I> sketch = new CmSketchBlockSegment<int, I>(512, EqualityComparer<int>.Default);

        public CmSketchBlockSegmentTestBase()
        {
        ...
        public void Repro()
        {
            sketch = new CmSketchBlockSegment<int, I>(1_048_576, EqualityComparer<int>.Default);
        ...
        {
            sketch = new CmSketchBlockSegment<int, I>(0, EqualityComparer<int>.Default);
        ...
        public void WhenSampleSizeExceededCountIsReset()
        {
            ...
            sketch = new CmSketchBlockSegment<int, I>(64, EqualityComparer<int>.Default);
