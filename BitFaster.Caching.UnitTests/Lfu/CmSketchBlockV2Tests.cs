...
namespace BitFaster.Caching.UnitTests.Lfu
{
    ...
    public class CMSketchBlockV2Avx2Tests : CmSketchBlockV2TestBase<DetectIsa>
    {
    }

    // Test with AVX2 disabled
    public class CmSketchBlockV2Tests : CmSketchBlockV2TestBase<DisableHardwareIntrinsics>
    {
    }

    public abstract class CmSketchBlockV2TestBase<I> where I : struct, IsaProbe
    {
        private CmSketchBlockV2<int, I> sketch = new CmSketchBlockV2<int, I>(512, EqualityComparer<int>.Default);

        public CmSketchBlockV2TestBase()
        {
        ...
        {
            sketch = new CmSketchBlockV2<int, I>(0, EqualityComparer<int>.Default);
        ...
        public void WhenSampleSizeExceededCountIsReset()
        {
            ...
            sketch = new CmSketchBlockV2<int, I>(64, EqualityComparer<int>.Default);
