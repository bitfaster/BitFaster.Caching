...
namespace BitFaster.Caching.UnitTests.Lfu
{
    ...
    public abstract class CmSketchTestBase<TAVX> where TAVX : struct, IAvx2Toggle
    {
        private CmSketch<int, TAVX> sketch = new CmSketch<int, TAVX>(512, EqualityComparer<int>.Default);
        ...
        {
            sketch = new CmSketch<int, TAVX>(0, EqualityComparer<int>.Default);
        ...
        public void WhenSampleSizeExceededCountIsReset()
        {
            ...
            sketch = new CmSketch<int, TAVX>(64, EqualityComparer<int>.Default);
        ...
        private static void SkipAvxIfNotSupported()
        {
            ...
            Skip.If(typeof(TAVX) == typeof(DetectAvx2) && !Avx2.IsSupported);
        }
    }
}
