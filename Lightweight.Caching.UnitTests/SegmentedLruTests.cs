...
namespace Lightweight.Caching.UnitTests
{
	public class SegmentedLruTests
	{
		...
		private SegmentedLru<int, string> lru = new SegmentedLru<int, string>(1, hotCap, warmCap, coldCap, EqualityComparer<int>.Default);
		private ValueFactory valueFactory = new ValueFactory();

		public SegmentedLruTests(ITestOutputHelper testOutputHelper)
		{
