...
{
    // This matches https://github.com/ben-manes/caffeine/blob/master/caffeine/src/main/java/com/github/benmanes/caffeine/cache/FrequencySketch.java
    public class CmSketchBlockSegment<T, I> where I : struct, IsaProbe
    {
        ...
        public CmSketchBlockSegment(long maximumSize, IEqualityComparer<T> comparer)
        {
