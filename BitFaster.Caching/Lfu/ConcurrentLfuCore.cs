...
namespace BitFaster.Caching.Lfu
{
    ...
    public class ConcurrentLfuCore<K, V> : ICache<K, V>, IAsyncCache<K, V>, IBoundedPolicy
    {
        ...
        {
            return ((ConcurrentLfuCore<K, V>)this).GetEnumerator();
        }
        ...
        {
            private readonly ConcurrentLfuCore<K, V> lfu;

            public LfuDebugView(ConcurrentLfuCore<K, V> lfu)
            {
                this.lfu = lfu;
            }
